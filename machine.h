...
static inline void Machine_Init(void)
{
    ...
    Machine_Add(MILL_MACHINE, 1, (Vector3) { 2060.37, 461.00, 200.41 }, PI / 2.0f, 1.0f, SCENE_HOME_WINDMILL_03);//far side castle
    Machine_Add(MILL_MACHINE, 2, (Vector3) { 1941.82, 410.00, -526.68 }, PI / 2.0f, 1.0f, SCENE_HOME_WINDMILL_04);
    Machine_Add(MILL_MACHINE, 3, (Vector3) { 1821.41, 480.00, -1176.68 }, PI / 2.0f, 1.0f, SCENE_HOME_WINDMILL_05);
