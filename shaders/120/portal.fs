...
void main() {
    ...
    vec3 blue = vec3(0.10, 0.015, 0.16); //not actually blue, dark purple
    ...
    float alpha = clamp(eComp * 1.25, 0.28, 1.0);
    alpha *= (1.0 - 0.25 * hot); // only up to 25% reduction in hot zones
